<div class="flex flex-col space-y-2">
    <div class="flex flex-col   p-5 space-y-2 border-b  dark:border-gray-400/40">
    ...
    <div class="inline-flex justify-center items-center space-x-5 py-4 border-t border-gray-200 dark:border-gray-400/40">
        <x-little-anonyme::form-components.fields.button.button class="" x-on:click="isOpen = false;$wire.closeMountFormAction()">
