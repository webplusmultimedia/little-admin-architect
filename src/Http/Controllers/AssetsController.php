...
class AssetsController
{
    ...
    public function __invoke(string $file)
    {
        switch ($file) {
            case 'app.css':
                return $this->pretendResponseIsFile(__DIR__ . '/../../../resources/dist/app.css', 'text/css; charset=utf-8');
            case 'app.css.map':
                return $this->pretendResponseIsFile(__DIR__ . '/../../../resources/dist/app.css.map', 'text/css; charset=utf-8');
            case 'app.js':
                return $this->pretendResponseIsFile(__DIR__ . '/../../../resources/dist/app.js', 'application/javascript; charset=utf-8');
            case 'app.js.map':
                return $this->pretendResponseIsFile(__DIR__ . '/../../../resources/dist/app.js.map', 'application/json; charset=utf-8');
            case 'echo.js':
